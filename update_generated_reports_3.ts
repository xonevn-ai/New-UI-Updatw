...
const regex = /\{\/\* Generated Reports \*\/\}\s*<div className="mb-8 bg-\[#111522\] rounded-xl border border-\[#222B45\]\/60 overflow-hidden">[\s\S]*?\{\/\* Session History \*\/\}/;
...
content = content.replace(regex, newGeneratedReports);

fs.writeFileSync('src/App.tsx', content);
console.log('Generated reports fixed');
