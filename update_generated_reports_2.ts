...
// 1. Update Generated Reports
const generatedReportsRegex = /\{\/\* Generated Reports \*\/\}\s*<div className="mb-8 bg-\[#111522\] rounded-xl border border-\[#222B45\]\/60 overflow-hidden">[\s\S]*?<\/div>\s*<\/div>/;
...
const newGeneratedReports = `{/* Generated Reports */}
        <div className="mb-8 bg-[#111522] rounded-xl border border-[#222B45]/60 overflow-hidden">
          ...
          <div className="p-4 space-y-6">
            ...
            {/* Last 7 Days Group */}
            {(selectedSystemKey === 'all' || selectedSystemKey === 'techTalk' || selectedSystemKey === 'proposal') && (
              <div className="space-y-3">
...
content = content.replace(generatedReportsRegex, newGeneratedReports);

fs.writeFileSync('src/App.tsx', content);
console.log('Generated reports updated');
